    ...
    await conn.sendMessage(m.chat, {
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          ...
          newsletterName: 'TOHID-AI VIBE SCANNER 💬',
          serverMessageId: 143
        }
      }
    });
  ...
  if (command === 'mirror') {
    ...
    await conn.sendMessage(m.chat, {
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          newsletterJid: '120363207624903731@newsletter',
          newsletterName: 'TOHID-AI MIRROR TOOL 🪞',
          serverMessageId: 143
        }
      }
    });
  ...
  if (command === 'topchatters') {
    ...
    await conn.sendMessage(m.chat, {
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          newsletterJid: '120363207624903731@newsletter',
          newsletterName: 'TOHID-AI CHAT STATS 📈',
          serverMessageId: 143
        }
      }
    });
  ...
  if (command === 'flipcoin') {
    ...
    await conn.sendMessage(m.chat, {
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          newsletterJid: '120363207624903731@newsletter',
          newsletterName: 'TOHID-AI COINFLIP 🎲',
          serverMessageId: 143
        }
      }
    });
  ...
  if (command === 'poem') {
    ...
    await conn.sendMessage(m.chat, {
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          newsletterJid: '120363207624903731@newsletter',
          newsletterName: 'TOHID-AI POEM DROP 📝',
          serverMessageId: 143
        }
      }
    });
